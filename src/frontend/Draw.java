...
public class Draw extends JPanel implements ActionListener{
	...
	public void paintComponent(Graphics g)
	{
		...
		{
			if(column >= 7)
				JOptionPane.showMessageDialog(this, "cannot insert coin here", "error", JOptionPane.PLAIN_MESSAGE);
			if(newgame.insertCoin(column) == -2)
				JOptionPane.showMessageDialog(this, "cannot insert coin here", "error", JOptionPane.PLAIN_MESSAGE);
			else
			{
				initUI(g);
				...
				if(winner == 1 )
					JOptionPane.showMessageDialog(this, "Player 1 wins\nCongratulations", "error", JOptionPane.PLAIN_MESSAGE);
				else if(winner == 2)
					JOptionPane.showMessageDialog(this, "Player 2 wins\nCongratulations", "error", JOptionPane.PLAIN_MESSAGE);
				else if(winner == -1) //draw
					JOptionPane.showMessageDialog(this, "The game ended as a DRAW", "error", JOptionPane.PLAIN_MESSAGE);
			}
...
//	}
	...
	private int calcYCoord(int rowNum)
	{
		return VER_GAP + rowNum*(TILE + TILES_GAP);
	}
}
